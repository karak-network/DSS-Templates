export const vaultAbi = [
  ...
  },
  {
    type: 'function',
    name: 'finishRedeem',
    inputs: [{ name: 'withdrawalKey', type: 'bytes32', internalType: 'bytes32' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
    name: 'getNextWithdrawNonce',
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_withdrawNonce', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [
      {
        name: '',
        type: 'tuple',
        internalType: 'struct WithdrawLib.QueuedWithdrawal',
        components: [
          { name: 'staker', type: 'address', internalType: 'address' },
          { name: 'start', type: 'uint96', internalType: 'uint96' },
  ...
  { type: 'function', name: 'requestOwnershipHandover', inputs: [], outputs: [], stateMutability: 'payable' },
  {
    ...
    name: 'slashAssets',
    inputs: [
      { name: 'totalAssetsToSlash', type: 'uint256', internalType: 'uint256' },
      { name: 'slashingHandler', type: 'address', internalType: 'address' },
    ],
    outputs: [{ name: 'transferAmount', type: 'uint256', internalType: 'uint256' }],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
    ...
    outputs: [{ name: 'withdrawalKey', type: 'bytes32', internalType: 'bytes32' }],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    name: 'FinishedRedeem',
    inputs: [
      { name: 'staker', type: 'address', indexed: false, internalType: 'address' },
      ...
      { name: 'shares', type: 'uint256', indexed: false, internalType: 'uint256' },
      { name: 'assetsClaimed', type: 'uint256', indexed: false, internalType: 'uint256' },
      { name: 'withdrawRoot', type: 'bytes32', indexed: false, internalType: 'bytes32' },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'operator', type: 'address', indexed: false, internalType: 'address' },
      { name: 'shares', type: 'uint256', indexed: false, internalType: 'uint256' },
      { name: 'withdrawKey', type: 'bytes32', indexed: false, internalType: 'bytes32' },
      { name: 'assets', type: 'uint256', indexed: false, internalType: 'uint256' },
    ],
    anonymous: false,
  },
  ...
  { type: 'error', name: 'MinWithdrawDelayNotPassed', inputs: [] },
