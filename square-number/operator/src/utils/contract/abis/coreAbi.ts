export const coreAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'slashingHandlers', type: 'address[]', internalType: 'address[]' },
    ],
    outputs: [],
  ...
  },
  {
    ...
    inputs: [{ name: 'vaultImpl', type: 'address', internalType: 'address' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
    ...
    inputs: [
      {
        ...
        components: [
          ...
          { name: 'earmarkedStakes', type: 'uint256[]', internalType: 'uint256[]' },
  ...
  },
  {
    ...
    inputs: [{ name: 'newVaultImpl', type: 'address', internalType: 'address' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'vaultImpl', type: 'address', internalType: 'address' },
    ],
    outputs: [{ name: 'vaults', type: 'address[]', internalType: 'contract IKarakBaseVault[]' }],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    outputs: [{ name: 'vaults', type: 'address[]', internalType: 'address[]' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    inputs: [{ name: 'dss', type: 'address', internalType: 'contract IDSS' }],
    outputs: [{ name: 'slashablePercentageWad', type: 'uint256', internalType: 'uint256' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
    ...
    outputs: [{ name: 'leverage', type: 'uint256', internalType: 'uint256' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    name: 'initialize',
    inputs: [
      { name: '_vaultImpl', type: 'address', internalType: 'address' },
      { name: '_manager', type: 'address', internalType: 'address' },
      { name: '_vetoCommittee', type: 'address', internalType: 'address' },
      { name: '_hookCallGasLimit', type: 'uint32', internalType: 'uint32' },
      { name: '_supportsInterfaceGasLimit', type: 'uint32', internalType: 'uint32' },
      { name: '_hookGasBuffer', type: 'uint32', internalType: 'uint32' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    type: 'function',
    name: 'pause',
    inputs: [{ name: 'map', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    name: 'pauseVault',
    inputs: [
      { name: 'vault', type: 'address', internalType: 'contract IKarakBaseVault' },
      { name: 'map', type: 'uint256', internalType: 'uint256' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    type: 'function',
    name: 'registerDSS',
    inputs: [{ name: 'maxSlashablePercentageWad', type: 'uint256', internalType: 'uint256' }],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [
      { name: 'dss', type: 'address', internalType: 'contract IDSS' },
      { name: 'registrationHookData', type: 'bytes', internalType: 'bytes' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
    ...
    inputs: [
      {
        ...
        components: [
          { name: 'operator', type: 'address', internalType: 'address' },
          { name: 'slashPercentagesWad', type: 'uint96[]', internalType: 'uint96[]' },
          { name: 'vaults', type: 'address[]', internalType: 'address[]' },
        ],
      },
    ],
  ...
  },
  {
    ...
    inputs: [
      { name: 'dss', type: 'address', internalType: 'contract IDSS' },
      { name: 'unregistrationHookData', type: 'bytes', internalType: 'bytes' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
    ...
    inputs: [{ name: 'assets', type: 'address[]', indexed: false, internalType: 'address[]' }],
    anonymous: false,
  },
  {
    type: 'event',
    ...
    inputs: [
      { name: 'canceller', type: 'address', indexed: false, internalType: 'address' },
      {
        name: 'queuedSlashing',
        type: 'tuple',
        indexed: false,
  ...
  },
  {
    ...
    name: 'DSSRegistered',
    inputs: [
      { name: 'dss', type: 'address', indexed: false, internalType: 'address' },
      { name: 'maxSlashablePercentageWad', type: 'uint256', indexed: false, internalType: 'uint256' },
    ],
    anonymous: false,
  },
  {
    ...
    inputs: [
      { name: 'finisher', type: 'address', indexed: false, internalType: 'address' },
      {
        name: 'queuedSlashing',
        type: 'tuple',
        indexed: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'map', type: 'uint256', indexed: false, internalType: 'uint256' },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'roles', type: 'uint256', indexed: true, internalType: 'uint256' },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    ...
    inputs: [{ name: 'implementation', type: 'address', indexed: false, internalType: 'address' }],
    anonymous: false,
  },
  {
    type: 'event',
  ...
  { type: 'error', name: 'AttemptedPauseWhileUnpausing', inputs: [] },
  { type: 'error', name: 'AttemptedUnpauseWhilePausing', inputs: [] },
  { type: 'error', name: 'DSSNotRegistered', inputs: [] },
  { type: 'error', name: 'EnforcedPause', inputs: [] },
  {
    type: 'error',
    name: 'EnforcedPauseFunction',
    inputs: [{ name: 'functionIndex', type: 'uint8', internalType: 'uint8' }],
  },
  { type: 'error', name: 'InvalidInitialization', inputs: [] },
  { type: 'error', name: 'NewOwnerIsZeroAddress', inputs: [] },
  { type: 'error', name: 'NoHandoverRequest', inputs: [] },
  { type: 'error', name: 'NotInitializing', inputs: [] },
  { type: 'error', name: 'NotSmartContract', inputs: [] },
  { type: 'error', name: 'OperatorNotValidatingForDSS', inputs: [] },
  { type: 'error', name: 'Reentrancy', inputs: [] },
  { type: 'error', name: 'ReservedAddress', inputs: [] },
  { type: 'error', name: 'Unauthorized', inputs: [] },
  { type: 'error', name: 'VaultImplNotAllowlisted', inputs: [] },
  { type: 'error', name: 'VaultNotAChildVault', inputs: [] },
